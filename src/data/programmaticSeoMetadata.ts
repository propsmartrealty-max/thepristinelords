...
export const PROGRAMMATIC_SEO_CONFIGS: Record<string, PageSeoConfig> = {
  '/': {
    ...
    keywords: "Pristine The Lords, Pristine The Lords Baner, Pristine Developers Pune, 3 BHK Baner, 4.5 BHK Sky Villa Pune"
  },
  '/pristine-the-lords-baner-project-overview': {
    ...
    keywords: "Pristine The Lords Baner, Pristine Developers Pune, Baner Pashan Link Road luxury apartments"
  },
  '/pristine-the-lords-baner-3-bhk-luxury-apartments': {
    ...
    keywords: "Pristine The Lords 3 BHK, 3 BHK flats Baner Pune, luxury 3 BHK Baner Pashan Link Road, 3 BHK price Pristine The Lords"
  },
  '/pristine-the-lords-baner-4-5-bhk-sky-villas': {
    ...
    keywords: "Pristine The Lords 4 BHK, 4.5 BHK Sky Villa Pune, duplex penthouse Baner, luxury apartments Pune above 3 crore"
  },
  '/pristine-the-lords-baner-master-layout-floor-plans': {
    ...
    keywords: "Pristine The Lords floor plans, Pristine The Lords master layout, 3 BHK floor plan Baner, 4 BHK floor plan Baner"
  },
  '/pristine-the-lords-baner-luxury-amenities-sky-lounge': {
    ...
    keywords: "Pristine The Lords amenities, Level 34 Sky Lounge Baner, luxury clubhouse Baner Pashan, rooftop amenities Pune"
  },
  '/pristine-the-lords-baner-specifications-mivan-italian-marble': {
    ...
    keywords: "Pristine The Lords specifications, Mivan construction Pune, Italian marble flats Baner, Pristine construction quality"
  },
  '/pristine-the-lords-baner-pashan-link-road-location': {
    ...
    keywords: "Pristine The Lords location, Baner Pashan Link Road flats, luxury apartments near Baner High Street, property near Hinjewadi"
  },
  '/pristine-the-lords-baner-transit-commute-hinjewadi-balewadi': {
    ...
    keywords: "Pristine The Lords commute, Hinjewadi IT Park luxury flats, Balewadi High Street apartments, Baner connectivity"
  },
  '/pristine-the-lords-baner-nri-real-estate-investment': {
    ...
    keywords: "NRI property investment Pune, NRI buying flat in Baner, FEMA real estate India, Dubai NRI luxury homes Pune"
  },
  '/pristine-the-lords-baner-pune-luxury-real-estate-above-2-crore': {
    ...
    keywords: "luxury property Pune above 2 crore, flats above 2 crore Baner, 2 crore luxury apartments Pune, HNI real estate Pune"
  },
  '/pristine-the-lords-baner-keyword-search-directory': {
    ...
    keywords: "Pristine Developers projects directory, Pristine Pune search directory, Pristine properties all projects"
  },
  '/pristine-the-lords-baner-maharera-p52100078557-status': {
    ...
    keywords: "Pristine The Lords MahaRERA P52100078557, MahaRERA verified luxury flats Pune, Pristine Developers legal status"
  },
  '/pristine-the-lords-baner-faqs-price-possession': {
    ...
    keywords: "Pristine The Lords FAQs, Pristine The Lords possession date, Pristine The Lords price per sq ft, maintenance charges"
  },
  '/pristine-the-lords-baner-brochure-download-pdf': {
    ...
    keywords: "Pristine The Lords brochure download, Pristine The Lords floor plan pdf, Pristine brochure Pune"
  },
  '/pristine-the-lords-baner-banking-institutional-financing': {
    ...
    keywords: "Capri Global Capital Limited real estate, Pristine The Lords bank approval, home loans Pristine The Lords"
  },
  ...
  '/pristine-the-lords-baner-pashan-link-road-investment-guide': {
    ...
    keywords: "Baner Pashan Link Road investment guide, Pune real estate appreciation 2026, luxury property investment Pune"
  },
  '/pristine-the-lords-baner-3-bhk-vs-4-bhk-roi-comparison': {
    ...
    keywords: "3 BHK vs 4 BHK ROI Pune, rental yield luxury apartments Baner, capital appreciation Pristine The Lords"
  },
  '/pristine-the-lords-baner-nri-fema-investment-guide': {
    ...
    keywords: "FEMA rules NRI real estate, NRE NRO repatriation real estate India, NRI property tax exemption Pune"
  },
  '/pristine-the-lords-baner-maharera-due-diligence-checklist': {
    ...
    keywords: "MahaRERA due diligence checklist, how to check MahaRERA portal Pune, clear title flats Pune"
  },
  '/pristine-the-lords-baner-mivan-construction-technology': {
    ...
    keywords: "Mivan construction technology benefits, monolithic concrete high-rise Pune, Pristine structural engineering"
  }
};

export function getSeoConfigForPath(pathname: string): PageSeoConfig {
  const cleanPath = pathname.toLowerCase().replace(/\/$/, '') || '/';
  return PROGRAMMATIC_SEO_CONFIGS[cleanPath] || PROGRAMMATIC_SEO_CONFIGS['/'];
}
